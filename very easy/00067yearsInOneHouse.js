...
function yearsInOneHouse(age, moved) {
  let totalChangeHouse = moved + 1;
  let averageChangeHouse = age / totalChangeHouse;
  return Math.round(averageChangeHouse);
}
...
console.log(yearsInOneHouse(7, 1));
